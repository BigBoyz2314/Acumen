...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-gradient-to-t from-[#E5F0FF] via-[#F5F7FF] to-white dark:border-strokedark dark:bg-gradient-to-t dark:from-blacksection dark:via-blackho dark:to-black">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-10 lg:py-15">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <h2 className="mb-5 pr-5 text-lg font-bold text-black dark:text-white whitespace-nowrap">
                We Develop {"   "}
              ...
              <div className="flex w-full flex-col gap-16 md:flex-row md:justify-start lg:w-2/3 xl:w-7/12">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
                ...
                >
                  ...
                  <ul>
                    <li className="mb-3">
                      <h6 className="text-xl font-medium text-black dark:text-white">Address:</h6>
                      13-C Galib Road, Gulberg II,
                      <br /> Lahore, Pakistan
                    </li>
                    <li className="mb-3">
                      <h6 className="text-xl font-medium text-black dark:text-white">Email:</h6>
                      <a
                        href="mailto:info@theacumentechnologies.com"
                      >
                        info@theacumentechnologies.com
                      </a>
                    </li>
                    <li className="mb-3">
                      <h6 className="text-xl font-medium text-black dark:text-white">Phone:</h6>
                      <a
                        href="tel:+9204235757992"
                      >
                        +92 042 35757992
                      </a>
                    </li>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Acumen Technologies. All rights reserved
              </p>
            </motion.div>
