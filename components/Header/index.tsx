  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          <a href="/">
            <Image
              ...
              width={140}
              height={30}
              className="hidden w-full dark:block pe-6"
            />
            <Image
        ...
        >
          <nav>
            <ul className="flex flex-col gap-5 pr-14 xl:flex-row xl:items-center xl:gap-10">
                    ...
                    <>
                      ...
                      >
                        {menuItem.submenu.map((item, key) => (
                          <li key={key} className="hover:text-primary flex items-center">
                            {item.icon && (
                              <span className="mr-3" dangerouslySetInnerHTML={{ __html: item.icon }}>
                              </span>
                            )}
