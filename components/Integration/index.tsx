        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: "INTEGRATIONS",
              subtitle:
                "Seamlessly Integration with leading technologies",
              description:
                "Effortlessly integrate with your favorite applications to streamline workflows and enhance productivity. Connect with CRMs, ERPs, payment gateways, and third-party services to ensure seamless data synchronization and automation.",
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="/images/lang-tech/graphql.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="/images/lang-tech/PHP-logo.svg.png"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="/images/lang-tech/Microsoft_.NET_logo.png"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="/images/lang-tech/WordPress_blue_logo.svg.png"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="/images/lang-tech/Node.js_logo.svg.png"
                  alt="Brand"
                />
              </div>
            </motion.div>
