...
export const metadata: Metadata = {
  title: "Wordpress Development - Acumen Technologies",
  description: "Wordpress Development - Acumen Technologies",
  // other metadata
};
          ...
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <h1 className="mb-5 pr-5 text-3xl font-bold text-black dark:text-white xl:text-hero ">
                ...
                sleek corporate site, an e-commerce platform, or a custom WordPress
                solution, we ensure your online presence is robust, secure, and
                optimized for performance. Partner with us to bring your vision to
                life and stay ahead in the digital landscape.
                </p>
            </div>
