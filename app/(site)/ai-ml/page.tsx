...
export const metadata: Metadata = {
  title: "AI & Machine Learning - Acumen Technologies",
  description: "AI & Machine Learning - Acumen Technologies",
  // other metadata
};
          ...
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <p>
                ...
                Whether you need predictive analytics, natural language
                processing, or custom AI models, we ensure our solutions are
                tailored to meet your unique challenges. Partner with us to
                unlock the full potential of AI and Machine Learning and stay
